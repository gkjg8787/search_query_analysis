...
def test_partial_template():
    ...
    bic_correct = {
        ...
        "generate": [
            {
                "url": "https://www.biccamera.com/bc/category/001/100/?q={keyword}",
                "category_value": "001100",
            },
            {
                "url": "https://www.biccamera.com/bc/category/?q={keyword}",
                "category_value": "",
            },
        ],
    }
    ...
    rakuten_correct = {
        ...
        "generate": [
            {
                "url": "https://search.rakuten.co.jp/search/mall/{keyword}/100227/",
                "category_value": "100227",
            },
            {
    ...
    matsukiyo_correct = {
        ...
        "generate": [
            {
                "url": "https://www.matsukiyococokara-online.com/store/catalogsearch/result?search_keyword={keyword}&categories=%7B%2200600000000000000%22%3A%22%E6%97%A5%E7%94%A8%E5%93%81%E3%83%BB%E3%83%9A%E3%83%83%E3%83%88%22%7D&layout=1",
                "category_value": "00600000000000000",
                "category_name": "日用品・ペット",
            },
            {
                "url": "https://www.matsukiyococokara-online.com/store/catalogsearch/result?search_keyword={keyword}&layout=1",
                "category_value": "",
            },
        ],
    }
    ...
    yodobashi_correct = {
        ...
        "generate": [
            {
                "url": "https://www.yodobashi.com/category/21484/?word={keyword}",
                "keyword": None,
                "category_value": "category/21484/",
            },
            {
    ...
    def _build_url_and_assert(analysis, correct):
        for gen in correct["generate"]:
            result = url_analysis.partial_template(
                analysis,
                gen.get("keyword"),
                gen.get("category_value"),
                gen.get("category_name", "category_name"),
            )
            print("Build:", result)
            assert result == gen["url"], "URL generation failed"
